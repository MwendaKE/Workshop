...
class AddBookCategWindow(Screen):
    category = ObjectProperty(None)
    
    def __init__(self, **kwargs):
        super(AddBookCategWindow, self).__init__(**kwargs)
    ...
    def refresh_all_categories(self):
        ...
        self.manager.get_screen('addbook').ids.book_category_spinner.values = ao.load_categories()
        self.manager.get_screen('addbook').ids.book_category_spinner.text = self.categdata
