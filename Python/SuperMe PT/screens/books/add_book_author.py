...
class AddAuthorBookWindow(Screen):
    ...
    def __init__(self, **kwargs):
        super(AddAuthorBookWindow, self).__init__(**kwargs)
    ...
    def refresh_addbook_window(self):
        ...
        self.manager.get_screen('addbook').ids.book_author_spinner.text = self.authorname
