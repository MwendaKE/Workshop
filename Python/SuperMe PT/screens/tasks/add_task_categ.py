...
class AddTaskCategWindow(Screen):
    category = ObjectProperty(None)
    
    def __init__(self, **kwargs):
        super(AddTaskCategWindow, self).__init__(**kwargs)
    ...
    def refresh_all_categories(self):
        ...
        self.manager.get_screen('addtask').ids.task_categ_spinner.values = ao.load_categories()
        self.manager.get_screen('addtask').ids.task_categ_spinner.text = self.categdata
