...
class EditTaskAddCategoryWindow(Screen):
    category = ObjectProperty(None)
    
    def __init__(self, **kwargs):
        super(EditTaskAddCategoryWindow, self).__init__(**kwargs)
    ...
    def refresh_all_categories(self):
        ...
        self.manager.get_screen('editask').ids.task_categ_spinner.values = ao.load_categories()
        self.manager.get_screen('editask').ids.task_categ_spinner.text = self.categdata
        
        self.manager.current = "editask"
