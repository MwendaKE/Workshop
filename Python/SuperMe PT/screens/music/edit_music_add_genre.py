...
class EditMusicAddGenreWindow(Screen):
    genre = ObjectProperty(None)
    
    def __init__(self, **kwargs):
        super(EditMusicAddGenreWindow, self).__init__(**kwargs)
    ...
    def refresh_genres(self):
        ...
        self.manager.get_screen('editmusic').ids.music_genre_spinner.values = mo.load_genres()
        self.manager.get_screen('editmusic').ids.music_genre_spinner.text = self.genredata
